...
class Build427IncrementalChangeService:
 ...
 def change_status(self):
  s=self.change427.status();return {**s,'version_coherent':RUNTIME_BUILD==SCHEMA_VERSION==self.BUILD,'phase':19,'phase19_builds_completed':7,'production_release_ready':False}
