...
class Build431NewsProvenanceService:
 ...
 def provenance_status(self):
  s=self.provenance431.status();return {**s,'version_coherent':RUNTIME_BUILD==SCHEMA_VERSION==self.BUILD,'phase':19,'phase19_builds_completed':11,'production_release_ready':False}
