...
class Build437CrossSourceEntityResolutionService:
 ...
 def entity_resolution_status_437(self):
  s=self.resolution437.status();return {**s,'version_coherent':RUNTIME_BUILD==SCHEMA_VERSION==self.BUILD,'phase':19,'phase19_builds_completed':17,'production_release_ready':False}
