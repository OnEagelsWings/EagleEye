...
class NewsConnectors429:
 ...
 def case_items(self,case_id):return [dict(r) for r in self.db.all('SELECT * FROM news_item_429 WHERE case_id=? ORDER BY published_at DESC,created_at DESC',(case_id,))]
